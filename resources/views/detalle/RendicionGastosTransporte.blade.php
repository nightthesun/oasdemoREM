                    ...
                    <form method="POST" action="{{ route('rendiciongastostransporte.store') }}">
                        ...
                        <div class=" row d-flex justify-content-center">
                            ...
                            <div class="col-6 d-flex align-items-center justify-content-center">
                                <h3 class="text-center text-primary">FORMULARIO DE RENDICION DE GASTOS DE TRANSPORTE</h3>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-primary" id="tabla" >
                                     <thead class="text-center">
                                        ...
                                        <th style="width:15%;" class="align-middle">HORA INICIO</th>
                                        <th style="width:15%;" class="align-middle">HORA FIN</th>
                                        <th style="width:15%;" class="align-middle">CENTRO DE COSTO</th>
                                        <th style="width:25%;" class="align-middle">RAZON SOCIAL</th>
                                        <th class="align-middle">MOTIVO DE VISITA</th>
                                     ...
                                     <tbody>
                                        ...
                                        <td>
                                            <input id="hora_ini{{$g}}" type="time" value="{{$g->hora_ini}}" class="form-control @error('hora_ini') is-invalid @enderror" name="hora_ini{{$g}}" required>
                                            @error('hora_ini')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <td>
                                            <input id="hora_fin{{$g}}" type="time" value="{{$g->hora_fin}}" class="form-control @error('hora_fin') is-invalid @enderror" name="hora_fin{{$g}}" required>
                                            @error('hora_fin')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <td>
                                            <input id="motivo{{$g}}" type="text" value="{{$g->motivo}}" class="form-control @error('motivo') is-invalid @enderror" name="motivo{{$g}}">
                                            @error('motivo')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
...
<script>
    ...
    $(document).ready(function(){
        $(".add-row").click(function()
        {
            ...
            '<td><input id="hora_ini'+cont+'" type="time" value="" class="form-control @error("hora_ini'+cont+'") is-invalid @enderror" name="hora_ini'+cont+'" required></td>'+
            '<td><input id="hora_fin'+cont+'" type="time" value="" class="form-control @error("hora_fin'+cont+'") is-invalid @enderror" name="hora_fin'+cont+'" required></td>'+
            ...
            '<td><input id="motivo'+cont+'" type="text" class="form-control @error("motivo'+cont+'") is-invalid @enderror" name="motivo'+cont+'"></td>'+
