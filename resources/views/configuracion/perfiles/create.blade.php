        ...
        <div class="row">                            
            ...
            <div class="col-10 border border-primary rounded">
                        ...
                        <div class="form-group row d-flex">
                            ...
                            <div class="col-md-3">
                                <input id="dias_vacacion" type="number" class="form-control @error('dias_vacacion') is-invalid @enderror" name="dias_vacacion" value="{{ old('dias_vacacion') }}"  autocomplete="dias_vacacion" autofocus>
                                @error('dias_vacacion')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
