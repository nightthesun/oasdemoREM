...
<div class="wrapper">
  @include('layouts.lateralbar')
    <div class="container-fluid border rounded bg-light m-5 ancho_container">
          <div class="row p-2">
            <div class="col-12"><h3>RENDICION DE GASTOS DE VIATICOS</h3></div>
          </div>
          <div class="row pb-4">
            <div class="col">
            </div>
            ...
            <table class="table table-hover table-primary" >
             ...
             <tbody>
              ...
              <tr>
                ...
                <td>{{$f->tipo}}</td>
                <td>{{$f->val==2}}</td>
                <td><a class="btn btn-primary btn-xs" href="{{action('RendicionGastosViaticoController@edit', $f->id)}}" ><span class="glyphicon glyphicon-pencil">Detalle</span></a></td>
               </tr>
               @endforeach
               @else
               <tr>
