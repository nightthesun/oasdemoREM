                                ...
                                <div class="table-responsive">
                                    <table class="table table-sm table-hover table-bordered" id="tabla" >
                                     ...
                                     <tbody>
                                         ...
                                         <tr>
                                            ...
                                            <td>{{$g->concepto}}</td>
                                            <td>{{$g->n_fac}}</td>
                                            <td class="text-right">{{$g->haber}}</td>
                                        </tr>
                                        @endforeach
                                        <tr>
                                        <td >
                                            
                                            <input id="fecha[0]" type="date" value="{{date('Y-m-d')}}" class="form-control form-control-sm @error('fecha[0]') is-invalid @enderror" name="fecha[0]" required>
                                            @error('fecha[0]')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <td>
                                               <input id="total" value ="{{$form->total}}" type="text" class="form-control form-control-sm @error('total') is-invalid @enderror" name="total" readonly>
                                               @error('total')
                                                   <span class="invalid-feedback" role="alert">
                                                       <strong>{{ $message }}</strong>
                                                   </span>
    ...
    $(document).ready(function(){
        ...
        {         
            ...
            '@error("fecha['+cont+']")'+
                ...
                '</span>'+
            '@enderror'+
            '<td><select id="centro_c['+cont+']" type="text" class="form-control  form-control-sm" name="centro_c['+cont+']">'+
                ...
                '<option value="Planta el Alto">Planta el Alto</option>'+
                '<option value="Santa Cruz">Santa Cruz</option>'+
            '<td><select id="cuenta_c['+cont+']" type="text" class="form-control  form-control-sm" name="cuenta_c['+cont+']">'+
                '<option disabled selected value="nada">Seleccione Tipo de gasto.</option>'+
                '<option value="Movilidad">Movilidad</option>'+
                '<option value="Trans. Flete">Trans. Flete</option>'+
                '<option value="Mantenimiento de Equipos">Mantenimiento de Equipos</option>'+
                '<option value="Servicio de te">Servicio de te</option>'+
                ...
                '<option value="Refrigerios">Fotocopias</option>'+
                '<option value="Gastos varios">Gastos varios</option>'+
                '<option value="Material de Limpieza">Material de limpieza</option></select></td>'+
            '<td><input id="razon_s['+cont+']" type="text" class="form-control form-control-sm @error("razon_s['+cont+']") is-invalid @enderror" name="razon_s['+cont+']"></td>'+
            '<td><input id="detalle['+cont+']" type="text" class="form-control form-control-sm @error("detalle['+cont+']") is-invalid @enderror" name="detalle['+cont+']"></td>'+
            '<td><input id="no_fac['+cont+']" type="text" class="form-control form-control-sm @error("no_fac['+cont+']") is-invalid @enderror" name="no_fac['+cont+']"></td>'+
